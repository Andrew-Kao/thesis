...
ged <- leaMaster %>%
  select('LEA_ADDRESS','LEA_CITY','LEA_ZIP', 'LEAID',
         'LEA_GED_IND', 'LEA_GEDPART_HI_M', 'LEA_GEDPART_HI_F', 'TOT_GEDPART_M', 'TOT_GEDPART_F', # participate, hispanic m/f, total m/f
          'LEA_GEDCRED_HI_M', 'LEA_GEDCRED_HI_F', 'TOT_GEDCRED_M', 'TOT_GEDCRED_F',
        'LEA_GEDPART_HI_M', 'LEA_GEDPART_HI_F', 'LEA_GEDPART_AS_M', 'LEA_GEDPART_AS_F',
        'LEA_GEDPART_WH_M', 'LEA_GEDPART_WH_F',  'LEA_GEDCRED_AS_M', 'LEA_GEDCRED_AS_F',
        'LEA_GEDCRED_WH_M', 'LEA_GEDCRED_WH_F') %>% 
...
gifted <- schoolMaster %>%
  select('SCHID','SCH_GT_IND', 'LEAID', # has gifted?
         ...
         'SCH_GTENR_AS_M', 'SCH_GTENR_AS_F', 'SCH_GTENR_BL_M', 'SCH_GTENR_BL_F') 
...
algebra1 <- schoolMaster %>%
  select('SCHID', 'SCH_ALGCLASSES_GS0708', 'SCH_ALGCERT_GS0708', 'LEAID', # number of classes, teachers
          ...
          'SCH_ALGPASS_G08_AS_M', 'SCH_ALGPASS_G08_AS_F', 'SCH_ALGPASS_G08_WH_M', 'SCH_ALGPASS_G08_WH_F', 
          'SCH_MATHENR_ADVM_HI_M', 'SCH_MATHENR_ADVM_HI_F', 'SCH_MATHENR_ADVM_AS_M', 'SCH_MATHENR_ADVM_AS_F',
          'SCH_MATHENR_ADVM_WH_M', 'SCH_MATHENR_ADVM_WH_F', 'SCH_MATHENR_CALC_HI_M', 'SCH_MATHENR_CALC_HI_F',
          'SCH_MATHENR_CALC_AS_M', 'SCH_MATHENR_CALC_AS_F', 'SCH_MATHENR_CALC_WH_M', 'SCH_MATHENR_CALC_WH_F',
          'SCH_SCIENR_BIOL_HI_M', 'SCH_SCIENR_BIOL_HI_F', 'SCH_SCIENR_BIOL_AS_M', 'SCH_SCIENR_BIOL_AS_M',
          'SCH_SCIENR_BIOL_AS_M', 'SCH_SCIENR_BIOL_AS_F', 'SCH_SCIENR_BIOL_WH_M', 'SCH_SCIENR_BIOL_WH_F',
          'SCH_SCIENR_CHEM_HI_M', 'SCH_SCIENR_CHEM_HI_F', 'SCH_SCIENR_CHEM_WH_M', 'SCH_SCIENR_CHEM_WH_F',
          'SCH_SCIENR_CHEM_AS_M', 'SCH_SCIENR_CHEM_AS_F', 'SCH_SCIENR_PHYS_HI_M', 'SCH_SCIENR_PHYS_HI_F',
          'SCH_SCIENR_PHYS_AS_M', 'SCH_SCIENR_PHYS_AS_F', 'SCH_SCIENR_PHYS_WH_M', 'SCH_SCIENR_PHYS_WH_F') 
...
ap <- schoolMaster %>%
  select('SCHID','LEAID','SCH_APENR_IND', 'SCH_APMATHENR_IND', 'SCH_APSCIENR_IND', # AP indicator/math/sci
         ...
         'SCH_APENR_AS_M','SCH_APENR_AS_F', 'SCH_APENR_WH_M','SCH_APENR_WH_F',
         'SCH_APENR_BL_M','SCH_APENR_BL_F',
         'SCH_APMATHENR_HI_M', 'SCH_APMATHENR_HI_F', 'TOT_APMATHENR_M', 'TOT_APMATHENR_F', # math
         'SCH_APMATHENR_WH_M', 'SCH_APMATHENR_WH_F', 'SCH_APMATHENR_AS_M', 'SCH_APMATHENR_AS_F',
         'SCH_APSCIENR_HI_M','SCH_APSCIENR_HI_F','TOT_APSCIENR_M','TOT_APSCIENR_F', # science
         'SCH_APSCIENR_AS_M','SCH_APSCIENR_AS_F', 'SCH_APSCIENR_WH_M','SCH_APSCIENR_WH_F',
         ...
         'SCH_APPASS_ONEORMORE_AS_M', 'SCH_APPASS_ONEORMORE_AS_F', 'SCH_APPASS_ONEORMORE_WH_M', 'SCH_APPASS_ONEORMORE_WH_F',
         'SCH_APPASS_ONEORMORE_BL_M', 'SCH_APPASS_ONEORMORE_BL_F') 
...
exam <- schoolMaster %>%
  select('SCHID','LEAID',
         ...
         'SCH_SATACT_AS_M', 'SCH_SATACT_AS_F', 'SCH_SATACT_WH_M', 'SCH_SATACT_WH_F')
saveRDS(exam, 'SchExam.Rdata')

absent <- schoolMaster %>%
  select('SCHID','LEAID',
         'SCH_ABSENT_HI_M','SCH_ABSENT_HI_F','TOT_ABSENT_M','TOT_ABSENT_F',
         'SCH_ABSENT_AS_M','SCH_ABSENT_AS_F','SCH_ABSENT_WH_M', 'SCH_ABSENT_WH_F',
         'SCH_ABSENT_BL_M','SCH_ABSENT_BL_F')
...
suspend <- schoolMaster %>%
  select('SCHID','LEAID', 
         ...
         'SCH_DISCWODIS_SINGOOS_HI_M', 'SCH_DISCWODIS_SINGOOS_HI_F', 'TOT_DISCWODIS_SINGOOS_M', 'TOT_DISCWODIS_SINGOOS_F', # one OSS
         'SCH_DISCWODIS_SINGOOS_AS_M', 'SCH_DISCWODIS_SINGOOS_AS_F', 'SCH_DISCWODIS_SINGOOS_BL_M', 'SCH_DISCWODIS_SINGOOS_BL_F',
...
harass <- schoolMaster %>%
  select('SCHID','LEAID',
         ...
         'SCH_HBREPORTED_RAC_AS_M', 'SCH_HBREPORTED_RAC_AS_F', 'SCH_HBREPORTED_RAC_WH_M', 'SCH_HBREPORTED_RAC_WH_F',
