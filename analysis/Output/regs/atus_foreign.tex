	...
	\scalebox{.8}{
		\begin{threeparttable}
			\begin{tabular}{lcccccccccc}
				...
				\multicolumn{4}{l}{Panel A: TV watched by foreign born residents} \\ %atus_2015_ext12
                              	\hline\addlinespace
