...
** main regression
ivreghdfe ihs_v hispanic inside hispanic_food hisp_inside hisp_hfood inside_hfood hisp_inside_hfood origloginc if sector == 72,  robust
est sto a1
...
ivreghdfe ihs_v greek_3 hispanic##inside##greek_food origloginc if sector == 72,  robust
est sto a1
...
ivreghdfe ihs_v japan_3 hispanic##inside##japanese_food origloginc if sector == 72,  robust
est sto a1
...
ivreghdfe ihs_v korea_3 hispanic##inside##korean_food origloginc if sector == 72,  robust
est sto a1

ivreghdfe ihs_v korea_3 hispanic##inside##korean_food origpchisp origloginc if sector == 72,  robust
est sto a2

ivreghdfe ihs_v  korea_3 hispanic##inside##korean_food origpchisp origloginc origlogpop if sector == 72, robust
est sto a3

ivreghdfe ihs_v  korea_3 hispanic##inside##korean_food origpchisp origloginc origlogpop if sector == 72, absorb(statecounty naics_code) robust
est sto a4
...
ivreghdfe ihs_v brazil_3 hispanic##inside##brazil_food origloginc if sector == 72,  robust
est sto a1
...
ivreghdfe ihs_v hispanic inside hispanic_loc hisp_inside hisp_hloc inside_hloc hisp_inside_hloc origloginc  if sector == 71, robust
est sto a1
...
ivreghdfe ihs_v greek_3l hispanic##inside##greek_loc origloginc  if sector == 71, robust
est sto a1
...
ivreghdfe ihs_v japan_3l hispanic##inside##japan_loc origloginc  if sector == 71, robust
est sto a1
...
ivreghdfe ihs_v korea_3l hispanic##inside##korea_loc origloginc  if sector == 71, robust
est sto a1

ivreghdfe ihs_v korea_3l hispanic##inside##korea_loc origpchisp origloginc if sector == 71, robust
est sto a2

ivreghdfe ihs_v korea_3l hispanic##inside##korea_loc origpchisp origloginc origlogpop if sector == 71, robust
est sto a3

ivreghdfe ihs_v korea_3l hispanic##inside##korea_loc origpchisp origloginc origlogpop if sector == 71, absorb(statecounty naics_code) robust
est sto a4
...
ivreghdfe ihs_v brazil_3l hispanic##inside##brazil_loc origloginc  if sector == 71, robust
est sto a1
