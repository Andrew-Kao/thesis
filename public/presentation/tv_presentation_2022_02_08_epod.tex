...
%%% TODO: HIGH LEVEL STAT ON INEQUALITY
...
\begin{frame}
\frametitle{TV Viewership within the SLTV Boundary}
...
Observations & 40,864 & 40,864 & 40,864 \\        
\hline\hline\addlinespace
\multicolumn{4}{l}{Panel B: IHS(Victims of Harassment on Basis of Ethnicity)}\\ 
\hline\addlinespace
...
\scalebox{1}{
			...
			\begin{tabular}{l|c|c}
				\hline\hline\addlinespace
				Outcome & White-Hispanic Gap & TV Regression Coeff. \\
                                \addlinespace\hline\addlinespace
                                Gifted students & 80.0\% & 1.3 - 1.6 \% \\
                                AP Students & 39.3\% & 4.7 - 7.2 \% \\
                                Pass AP & 22.7\% & 3.4 - 4.2 \% \\
                                Suspension & -30.0\% & 1.1 - 1.8 \% \\
                                Absent & -12.8\% & 6.7 - 7.4 \% \\
				\addlinespace\hline\hline
			\end{tabular}
...
\label{firm_close}
\begin{itemize}
\item Robustness \hyperlink{firm_spatial}{\beamergotobutton{Spatial autocorrelation}}  \hyperlink{firm_dist}{\beamergotobutton{Vary boundary cut-off and grid size}}   \hyperlink{firm_controls}{\beamergotobutton{Vary controls}} 
...
\end{center}
 \hyperlink{firm_close}{\beamergotobutton{Back}}
\end{frame}
