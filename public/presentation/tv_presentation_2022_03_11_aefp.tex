...
\centering
        ...
        \includegraphics[width=.5\textwidth]{figs/tv_time3}\\
\end{frame}
...
\item Station contours and other station data from the FCC
\end{itemize}

\item American Time Use Survey over last 15 years:
\begin{itemize}
\item 210,000 person-year observations
\item Average person watches 170 minutes of TV per day
\end{itemize}

\item Department of Education's Civil Rights Data Collection in 2015:
\begin{itemize}
...
\begin{itemize}
\item TV transcript data from archive.org
\item Foot-traffic data from Safegraph
\item Social connectedness data from Facebook
\end{itemize}
...
\begin{itemize}
\item Hispanics visit more Hispanic-branded establishments (restaurants, recreation businesses) when they have access to SLTV \hyperlink{safegraph_data}{\beamergotobutton{Data and table}}
\begin{itemize}
\item However, they are no more likely to visit Brazilian establishments (or Japanese, or Cajun/Creole etc.)
\end{itemize}
\item Counties with SLTV are more socially connected with Latin America \hyperlink{sci_data}{\beamergotobutton{Data and table}}
\begin{itemize}
