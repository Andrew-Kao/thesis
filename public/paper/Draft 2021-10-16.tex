...
\begin{document}
\title{\textbf{Seeing is Believing: Identity, Inequality, and the Impact of Television on Hispanics}%Unravel}
...
\begin{abstract}
\noindent  Can identity reduce inequality? Using a spatial regression discontinuity arising from a FCC regulation, I investigate the impact of Spanish Language Television (SLTV) on Hispanic students in public schools, finding that SLTV induces higher educational perfomance and helps close the Hispanic achievement gap. I marshal three of sources of evidence that each indicate an identity mechanism is at play: (1) more Hispanic students labelled `limited English proficiency' and bullied on the basis of their ethnicity in SLTV schools, (2) stronger educational performance in areas where SLTV programming focuses more on the Hispanic identity, and (3) greater traffic to Hispanic branded establishments from Hispanic visitors with SLTV. Collectively, they suggest that identity is a mechanism through which SLTV reduces inequality.
