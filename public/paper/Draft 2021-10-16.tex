...
The Hispanic achievement gap is wide and persistent: Hispanics face the lowest high school and college completion rates out of all major ethnic and racial groups in the United States.\footnote{See \cite{tienda_hispanicity_2009}. This achievement gap extends to many more educational outcomes, from test scores to disciplinary incidents to enrolment in advanced classes. TODO: other cites on the achievement gap.} In this paper, I argue that Spanish Language Television (SLTV) is a media technology that has reduced educational inequality, and that moreover, these gains in Hispanic student performance can be attributed (at least in part) to a heightened sense of a Hispanic identity.
% TODO: use citations and figures in https://www.colorincolorado.org/article/closing-achievement-gap-focus-latino-students-0

Americans spend an average of three hours a day watching TV---more than any activity bar sleeping. Accordingly, a large literature documents the impact that television has on education, but prior work has largely been correlational and findings remain conflicted. One mainstream line of research contends that TV is as a distraction which `rots' the mind and harms students \citep{zavodny_does_2006}.\footnote{ See \cite{aksoy2000panel}, \cite{hornik1981out}, and \cite{keith1986parental}. This theory enjoys popular support (see \cite{winn_plug-drug_2002} or \cite{gentile_well-child_2004} which finds broad support among paediatricians). \cite{huang2010dynamic} and \cite{nakamuro2015television} use causal identification strategies and also find negative (but generally much smaller) effects.} A more recent line of inquiry has found null effects of TV,\footnote{ \cite{gaddy1986television}, \cite{gortmaker1990impact}, and \cite{hu2020relationship} take correlational approaches, while \cite{munasib2010idiot} and \cite{kureishi2013does} use self-reportedly weak instruments.} with \cite{gentzkow_preschool_2008} unique in finding that TV improves student test scores---particularly among nonwhite and English language learners. 
 
Examining Spanish Language TV, in particular, allows me to take a closer look at Hispanic communities and examine its ties to identity. 78\% of Spanish-dominant households watch SLTV, while 50\% of multi-language Spanish-speaking homes do. In 2010, the top 10 broadcast shows in the Hispanic demographic category were all Spanish language programs \citep{pardo_three_2011}. Despite the rise of the internet, broadcast SLTV remains an important institution in Hispanic households. 
...
% Hispanic inequality in other sectors
...
\cite{fairlie2012academic} is another related study that randomly provides computers to low-income students and finds that treated minority students perform better academically.
