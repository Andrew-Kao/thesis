...
% TODO: robustness, Spanish only instrument (no EN/ES)
...
\subsection{Other data} \ref{a:auxiliarydata} describes other data used in the paper, including IPUMS migration data, American Community Survey data, and also describes in greater detail the data construction process for the datasets above.
