...
Table plan:
\begin{enumerate}
\item Summary stats table: education (school level), ATUS data, transcript data, Safegraph data
\item ATUS: first stage (93), children (99)
\item Education: top (and bottom?) performance
\item Education: identity
\item Transcript: identity
\item Safegraph: identity
\end{enumerate}

Appendix:
\begin{enumerate}
\item Migration table
\item ATUS: parents (97), foreign born (94)
