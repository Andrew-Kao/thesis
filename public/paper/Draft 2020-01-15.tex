...
\subsection{Broadcast TV and Controls}

To build the coverage contours of SLTV stations in the US, we collected a list of all SLTV stations via the TMS API (a large provider of data on TV, movies, and other media). 
