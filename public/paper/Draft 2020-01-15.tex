...
There's good reason to believe that identity, as reinforced through mass media, has a large effect on the lives people lead. \cite{oberholzer-gee_media_2009} demonstrate that the presence of Spanish language local news increases Hispanic voter turnout, while @CITE Yanigazawa-Drott (QJE 2014) shows that radio broadcasts in Rwanda contributed to the violence and genocide that took place in the 90s.  @CITE Olken finds that that radio and television decrease `social capital' in Indonesia, in line with @CITE Putnam's argument. \cite{velez_tuning_2019}, who first developed the instrument used in this paper, show that SLTV leads to lower voter turnout rates.\footnote{Other examples of media affecting identity and personal beliefs include \cite{@CITE Jensen, Oster}, \cite{@CITE Gentzkow, Shapiro 2004}, \cite{@CITE DellaVigna, Kaplan}, \cite{@CITE La Ferrara, Chong}, \cite{@CITE Kearney 2015}. For an overview, see \cite{@CITE DellaVigna La Ferrara 2015}}
...
Difficult to get entrepreneurrship/mixed:  \cite{@CITE Karlan Valdiva} (vs. us!)
