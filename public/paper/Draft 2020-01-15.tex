...
Difficult to get entrepreneurrship/mixed:  \cite{@CITE Karlan Valdiva} \cite{@CITE Gine Mansuri} (vs. us!)
...
This model is identical to the main specification, except the error terms are now additionally correlated due to the addition of the $\lambda W \epsilon$ term. In this model, spatial dependence enters through  the presence of missing spatial covariates which may affect the outcome.
