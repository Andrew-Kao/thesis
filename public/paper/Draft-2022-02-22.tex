...
Thus, though it is impossible to rule out all other stories that may drive this set of results, few can simultaneously explain the reversal in academic ability for English proficiency and the increased bullying on the basis of ethnicity (but not sex) among Hispanic students. A strengthened Hispanic identity through SLTV, wherein Hispanics feel a stronger affinity towards Hispanic cultural practices, people, and countries of origin, neatly fits these facts.
