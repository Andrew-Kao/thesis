...
% multiple bandwidths, see Pons & Tricaud (Calonico. Also Cattaneo). Also, general prediction test
%%% --> TO ADD: we run 8 different estimators proposed by Calonico and Cattaneo, these bandwidths range between 29-36. We present results at 33 KM
...
% ChatGPT abstract
% Spanish Language Television (SLTV) has the potential to improve academic outcomes for Hispanic students in public schools. Using a spatial regression discontinuity design, I analyze data from the FCC and the US Department of Education to investigate the effects of SLTV on Hispanic students. My findings suggest that SLTV can improve academic outcomes and narrow the Hispanic achievement gap, increasing the number of SAT and ACT tests taken, enrollment in calculus, and AP exams passed. However, SLTV also has negative effects, such as causing more Hispanic students to be labeled "limited English proficiency" and bullied on the basis of their ethnicity.
% I also explore the mechanisms through which SLTV affects student outcomes. I find that Hispanic students perform better academically where SLTV programming focuses more on the Hispanic identity, but not when it focuses more on role models or education itself. Furthermore, Hispanics with access to SLTV visit Hispanic-branded establishments more frequently and counties with access to SLTV are more socially connected to Latin America. These findings suggest that the effects of SLTV are driven by its effects on identity. Overall, my results indicate that SLTV can have both positive and negative effects on Hispanic students' academic and social experiences.
